...
def get_user_options():
    ...
    # 16번 옵션으로 Evaluation 저장 파일 이름 입력 추가
    eval_filename = get_input("16. Evaluation 결과 저장 파일명 (기본값: test_results)", "test_results")
    ...
    return {
        ...
        'restore': restore,
        'eval_filename': eval_filename  # 리턴 딕셔너리에 추가
    }
