...
from data_processing import load_scale_and_group_data, get_column_metadata
...
def main():
    ...
    iq_groups, style_groups, style_cols, total_iq_dim, total_style_dim = \
    get_column_metadata(TRAIN_FILE, iq_dim=60)
